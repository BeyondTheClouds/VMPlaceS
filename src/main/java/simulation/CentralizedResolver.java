...
import scheduling.entropyBased.btrplace.BtrPlace;
...
public class CentralizedResolver extends Process {
    ...
    public void main2(String[] args) throws MsgException {
        ...
        EntropyBasedScheduler scheduler;
        SchedulerResult entropyRes;
        ...
        try{
            while (!SimulatorManager.isEndOfInjection()) {
                ...
                scheduler = SchedulerSelector.createAndInitScheduler(hostsToCheck, loopID++);
