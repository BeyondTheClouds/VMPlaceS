...
import static bug.Main.hosts;

public class Migrator extends Process {
    public static final int SIMULATION_TIME = 360000 * 1;
    public static final int N_HOSTS = 64;
    public static final int N_VMS = N_HOSTS * 10;
    public static final float MIG_RATE = 0.2F;
