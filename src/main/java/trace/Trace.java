...
public class Trace {
     ...
     */
    static void hostStateDeclare(String host, String state) {
     ...
     */
    static void hostStateDeclare(String state) {
     ...
     * @param value
     */
    static void hostPushState(String host, String state, String value) {
     ...
     * @param value
     */
    static void hostVariableSet(String host, String variable, double value) {
     ...
     * @param value
     */
    static void hostVariableSub(String host, String variable, double value) {
     ...
     * @param value
     */
    static void hostVariableAdd(String host, String variable, double value) {
